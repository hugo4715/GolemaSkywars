...
public class CageMenuThirdPage extends VirtualMenu {

	private static Map<Player, Inventory> playerInventoryMap = new HashMap<Player, Inventory>();
	
	/**
	 * Constructeur du Menu de la page 3.
	 * 
	 * @param player
	 */
	@SuppressWarnings("unused")
	public CageMenuThirdPage(Player player) {
		super(player, "Plate-forme � 3", 6);
		
		/**
		 * Cages.
		 */
		for(CagesInfo cagesInfo : CagesInfo.values()) {
//			if(cagesInfo.getPage() == 3) {
